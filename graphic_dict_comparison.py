...
def calculate_gene_search_time(gene, target_codon):
    gene.find_codon_by_sequance(target_codon)

# Создание списка значений n от 100 до 100000 с шагом 1000
n_values = list(range(100, 100001, 1000))
